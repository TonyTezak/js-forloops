...
var topPop = ['Closer', 'Starboy', 'I Feel It Coming', 'Let Me Love You', '24K Magic'];
for(i=0; i<topPop.length; i++){
  console.log("This week's chart buster is: " + topPop[i]);
}
...
// for (var i = healthSnacks.length - 1; i>=0; i--{
//console.log(healthsnacks[1])
...
function copyArray(originArray, destinationArray){
  ...
  destinationArray.push(originArray);
  }
